namespace ApiTemplate.Controllers
{
    ...
    public class CarsController : ControllerBase
    {
        ...
        [SwaggerResponse(StatusCodes.Status400BadRequest, "The page request parameters are invalid.", typeof(ValidationProblemDetails))]
        ...
        [SwaggerResponse(StatusCodes.Status400BadRequest, "The patch document is invalid.", typeof(ValidationProblemDetails))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "A car with the specified unique identifier could not be found.")]
#endif
        ...
        [SwaggerResponse(StatusCodes.Status400BadRequest, "The car is invalid.", typeof(ValidationProblemDetails))]
#endif
